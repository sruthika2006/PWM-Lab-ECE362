...
void init_pwm_irq() {
    ...
    pwm_set_chan_level(s37, pwm_gpio_to_channel(37), p);
    pwm_set_chan_level(s38, pwm_gpio_to_channel(38), p);
    pwm_set_chan_level(s39, pwm_gpio_to_channel(39), p);

    pwm_clear_irq(s37);
    pwm_set_irq_enabled(s37, true);
